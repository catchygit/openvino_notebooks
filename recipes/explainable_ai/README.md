...
| |
| ------------- |
| 📔 [Jupyter Notebook](explainable_ai.ipynb)  |
| ▶️ [Code Demo Video](https://www.youtube.com/watch?v=InXb2wLCsJE) |
| 👥 [Share your results](https://github.com/openvinotoolkit/openvino_notebooks/discussions) |
